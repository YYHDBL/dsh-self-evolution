...
| A2 build & boot baseline | `A2-build-boot.md`, `A2-logupload-off.md`, `A2-v3-migration.md` | **PASS (complete)** — incl. minimal real PTC session `BASELINE_PTC_OK` after credentials were configured |
...
| A3 probe adaptation | `A3-probe-adaptation.md` | **PASS (complete)** — tests 3/3, real successful turn record matches handle (seq 17), marker lifecycle installed/removed/reinstalled |
